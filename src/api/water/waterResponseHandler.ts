...
import { WaterResponseData } from './waterSchemas';

export class WaterResponseHandler implements ResponseHandler {
  async getResponseData(data: string): Promise<WaterResponseData> {
