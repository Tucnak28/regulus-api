...
import { SolarResponseData } from './solarSchemas';

export class SolarResponseHandler implements ResponseHandler {
  async getResponseData(data: string): Promise<SolarResponseData> {
